...
// console.log(Number(true), "This is a boolean converted from a number");


//CONVERT BOOLEAN TO STRING

// console.log(String(true), "This is a string converted from a boolean");
// console.log(String(false), "This is a string converted from a boolean");
